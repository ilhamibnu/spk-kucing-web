        ...
        <div class="card-datatable table-responsive">
            ...
            <table class="table datatables table-hover responsive nowrap" style="width:100%" id="dataTable-1">
                ...
                <tbody class="table-border-bottom-0">
                    @foreach ($nilai_keyakinan as $data )
                    <tr>
                        ...
                        <div class="modal fade" id="Delete{{ $data->id }}" tabindex="-1" aria-hidden="true">
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    ...
                                    <form action="/nilai-keyakinan/{{ $data->id }}" method="post">
                                        @csrf
                                        @method('delete')
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="row">
                                                <div class="col mb-3">
                                                    ...
                                                    <input type="text" name="nilai" value="{{ $data->nilai }}" id="nameBasic" class="form-control" placeholder="Enter Nilai" required />
                                                </div>
                                            </div>
        ...
        <div class="modal fade" id="Add" tabindex="-1" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form action="/nilai-keyakinan" method="post">
                        @csrf
                        @method('post')
                        <div class="modal-body">
                            <div class="row">
                            ...
                            <div class="row">
                                <div class="col mb-3">
                                    <label for="nameBasic" class="form-label">Nilai</label>
                                    <input type="text" name="nilai" value="" id="nameBasic" class="form-control" placeholder="Enter Nilai" required />
                                </div>
                            </div>
