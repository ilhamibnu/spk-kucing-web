...
@section('title', '- Data Penyakit Kulit')

@section('content')
<div class="container-xxl flex-grow-1 container-p-y">
    <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Tables /</span> Data Penyakit Kulit</h4>
                ...
                <table class="table datatables table-hover responsive nowrap" style="width:100%" id="dataTable-1">
                    ...
                    <tbody class="table-border-bottom-0">
                        ...
                        <tr>
                            ...
                            <td>
                                <img src="{{ asset('penyakit-kulit/' . $data->image) }}" alt="" width="100px">
                            </td>
                            <td>{{$data->judul}}</td>
                            ...
                            <div class="modal fade" id="Delete{{ $data->id }}" tabindex="-1" aria-hidden="true">
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <form action="/penyakit-kulit/{{ $data->id }}" method="post">
                                            @csrf
                                            @method('delete')
                            ...
                            <div class="modal fade" id="Edit{{ $data->id }}" tabindex="-1" aria-hidden="true">
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <form action="/penyakit-kulit/{{ $data->id }}" method="post" enctype="multipart/form-data">
                                            @csrf
                                            @method('put')
                                            <div class="modal-body">
                                                <div class="row">
                                                    <div class="col mb-3">
                                                        ...
                                                        <input type="text" name="judul" value="{{ $data->judul }}" id="nameBasic" class="form-control" placeholder="Enter Kode" required />
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col mb-3">
        ...
        <div class="modal fade" id="Add" tabindex="-1" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form action="/penyakit-kulit" method="post" enctype="multipart/form-data">
                        @csrf
                        @method('post')
                        <div class="modal-body">
                            <div class="row">
